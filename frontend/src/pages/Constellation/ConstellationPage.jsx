...
import { createStar, createShootingStar, createConstellation } from '../../utils/constellationUtils'; // Import the utility functions
...
useEffect(() => {
    ...
    if (!constellationsFetched) {
        ...
        initializeStars(constellationContainer);
        initializeConstellation(constellationContainer);
        setTimeout(() => createShootingStar(constellationContainer), Math.random() * 20000);
    }
...
const initializeStars = (constellationContainer) => {
    for (let i = 0; i < 200; i++) {
    createStar(constellationContainer);
    }
};
...
return (
    ...
    {isEditMode ? (
        ...
        <div className="constellation-image-container" id="constellationContainer">
            {/* Visualization Section */}
        </div>
        
        <div className='constellation-info-container'>
            <div>
